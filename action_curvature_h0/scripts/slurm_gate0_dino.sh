#!/usr/bin/env bash
#SBATCH --job-name=acm_g0d
#SBATCH --partition=mig
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=04:00:00
#SBATCH --array=64-95%2
#SBATCH --output=/mnt/data/nhatnc129/jepa_runs/logs/acm_g0d_%A_%a.out
set -euo pipefail
...
"$PY" "$PROJECT/scripts/gate0_collect.py" \
  ...
  --checkpoint crod_dinowm_cube_seed42/weights_epoch_10.pt --out-dir "$PROJECT/outputs/gate0_dino"
