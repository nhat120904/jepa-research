...
#SBATCH --array=0-63%2
#SBATCH --output=/mnt/data/nhatnc129/jepa_runs/logs/perd_collect_%A_%a.out
set -euo pipefail
...
sha256sum "$PROJECT/core.py" "$PROJECT/scripts/collect_populations.py" "$PROJECT/scripts/slurm_01_collect.sh"
