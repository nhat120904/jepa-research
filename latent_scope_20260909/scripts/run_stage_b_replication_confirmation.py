"""Fixed-choice confirmation on trusted 52524 artifacts; compute nodes only."""
import argparse
import hashlib
import json
import os
...
def main():
    ...
    original = root / 'outputs/qualification_52524/qualification_result.json'
    ...
    if [(r['attempt'], r['selected_candidate']) for r in panel] != [(4, 4), (7, 1)]:
    ...
    try:
        ...
        for row in panel:
            ...
            for repeat in range(8):
                seed = 203000 + row['attempt'] * 100 + repeat
