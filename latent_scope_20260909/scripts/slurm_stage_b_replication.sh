#!/usr/bin/env bash
#SBATCH --job-name=lscope_q_replicate
...
CONFIG="$PROJECT_ROOT/latent_scope_20260909/configs/stage_b_replication.json"
PORT=$((20000 + SLURM_JOB_ID % 20000))
QUALIFICATION_TEST_JOB=52409
QUALIFICATION_RESTORE_JOB=52418
...
env MUJOCO_GL=osmesa PYOPENGL_PLATFORM=osmesa \
  ...
  "$RUNTIME_ROOT/sim_venv/bin/python" "$OUTPUT_DIR/scripts/run_stage_b_replication.py" \
