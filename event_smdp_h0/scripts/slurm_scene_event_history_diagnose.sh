#!/usr/bin/env bash
#SBATCH --job-name=scene_event_history_diag
#SBATCH --partition=mig
#SBATCH --cpus-per-task=2
#SBATCH --mem=16G
#SBATCH --time=00:20:00
#SBATCH --output=/mnt/data/nhatnc129/jepa_runs/logs/scene_event_history_diag_%j.out
set -euo pipefail
...
"$RUNTIME/.venv/bin/python" \
  ...
  --out-dir "$PROJECT/outputs/scene_event_history/diagnostic/${RUN_ID}"
