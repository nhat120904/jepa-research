#!/usr/bin/env bash
#SBATCH --job-name=lscope_b01_event
#SBATCH --partition=main
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=12
#SBATCH --mem=64G
#SBATCH --time=06:00:00
#SBATCH --output=/mnt/data/nhatnc129/jepa/latent_scope_baseline/logs/stage_b_event_%j.out
...
CONFIG="$PROJECT_ROOT/latent_scope_20260909/configs/stage_b_event_profile.json"
...
OUTPUT_DIR="$RUNTIME_ROOT/outputs/stage_b_event_$SLURM_JOB_ID"
