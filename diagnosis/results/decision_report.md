...
| --- | --- | --- | --- | --- |
| Metaworld | dino_wm_metaworld, jepa_wm_metaworld | 288 | 192 | 96 |
...
| model | regime | rows | transitions | CRA | CRA_eff [95% CI] | AUG | ECS |
| --- | --- | --- | --- | --- | --- | --- | --- |
| dino_wm_metaworld | free_space | 11 | 4547 | 0.527 | 0.568 [0.500, 0.635] | +0.0841 | +0.0952 |
| dino_wm_metaworld | pre_grasp | 10 | 5254 | 0.329 | 0.452 [0.358, 0.546] | +0.0455 | +0.0949 |
| dino_wm_metaworld | contact_manipulation | 11 | 3830 | 0.461 | 0.486 [0.423, 0.549] | +0.0753 | +0.0829 |
| jepa_wm_metaworld | free_space | 11 | 4547 | 0.602 | 0.634 [0.569, 0.698] | +0.0859 | +0.0965 |
| jepa_wm_metaworld | pre_grasp | 10 | 5254 | 0.408 | 0.530 [0.432, 0.625] | +0.0507 | +0.1046 |
| jepa_wm_metaworld | contact_manipulation | 11 | 3830 | 0.552 | 0.574 [0.510, 0.639] | +0.0874 | +0.0972 |

### DROID hard_nn by model/regime

| model | regime | rows | transitions | CRA | CRA_eff [95% CI] | AUG | ECS |
| --- | --- | --- | --- | --- | --- | --- | --- |
| dino_wm_droid | free_space | 1 | 998 | 0.082 | 0.000 [0.000, 0.000] | +0.0371 | +0.0294 |
| dino_wm_droid | pre_grasp | 1 | 518 | 0.072 | 0.072 [0.051, 0.096] | +0.0171 | +0.0171 |
| dino_wm_droid | gripper_actuation | 1 | 400 | 0.022 | 0.035 [0.015, 0.061] | +0.0289 | +0.0587 |
| dino_wm_droid | contact_manipulation | 1 | 415 | 0.059 | 0.059 [0.039, 0.083] | +0.0031 | +0.0026 |
